...
vector<pair<Instruction, int>> IO::parseInstructionFile(const string &instructionFilePath)
{
...
void IO::outputInstruction(const string &instructionFilePath, const vector<pair<Instruction, string>> &codeList)
{
...
vector<pair<Instruction, int>> IO::__parseInstructionFile(const string &instructionFilePath)
{
...
void IO::__outputInstruction(const string &instructionFilePath, const vector<pair<Instruction, string>> &codeList)
=======
